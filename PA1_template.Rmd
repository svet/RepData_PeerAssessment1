...
The mean steps per day is `r mean_steps` (shown in blue) and 
the median is `r median_steps` (shown in green)
...
The mean steps per day is `r mean_steps_ex` (shown in blue) and 
the median is `r median_steps_ex` (shown in green).
